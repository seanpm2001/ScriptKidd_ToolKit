print ("This is the basic multiplication with decimals calculator")
print ("Enter 2 numbers then see what the answer is")
print (" ")
print ("HOW THE PROGRAM WORKS")
print ("a and b are set as float commands. Float commands can store numbers with decimals. An input command is included")
